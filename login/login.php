...
Usuario ou Email: <br>
<center>
<input id="caixa" type="text" name="login" size="30" placeholder="Usuario ou Email"> <br>
</center>
Senha: <br>
...
<input type="submit" name="bt_verificar" value="Login" onclick= "document.form1.action='areaadm.php'">


<input type= "submit" name = "bt_login" value = "Nova Conta" onClick =  "document.form1.action='cadastrarcliente.php'">
